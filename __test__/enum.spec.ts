...
describe('TEnum', () => {
  ...
  describe('values/enum', () => {
    ...
    test('inference', () => {
      ...
      assertEqual<typeof stringEnum['enum'], { readonly a: 'a'; readonly b: 'b'; readonly c: 'c' }>(
        true
      )
      ...
      >(true)
      assertEqual<typeof nativeNumberEnum['enum'], { readonly A: 0; readonly B: 1; readonly C: 2 }>(
        true
      )
    })
  })
